...
public class CommonMethods extends BaseClass{
	...
	public static String takeScreenshot(String fileName) {
		//create timeStamp and add it to file name
		Date date = new Date();
		...
		try {
			FileUtils.copyFile(screenShot, new File(scrnshotFile));
		} catch (IOException e) {
	 ...
	 * Called this method inside other explicit wait methods
	 */
	 ...
	 * @param element
	 */
	public static void waitForInvisibilty(WebElement element) {
